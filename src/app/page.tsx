          ...
          <section className={"mb-10"}>
            ...
            <div className="text-sm px-5 py-2 text-center normal-case font-light rounded bg-label ">
              ...
              <p className="mb-5 text-xl">
                Підходить для <b>експертів</b> з будь якої ніші (ІТ, ШІ, Фітнес, Б&#39;юті, Наука і т.д.), спеціалістів, продюсерів, маркетологів
              </p>
          ...
          <section>
            <div className="md:basis-7/12 flex-initial grow-0 align-bottom dark:text-black">
              ...
              <ul className="mb-5 list-disc list-inside mt-5 text-xl leading-7">
                ...
                <li className={"mb-3"}>Заснувала Digital агенцію <b className={"uppercase"}>business maker</b> - розробка сайтів для бізнесу та експертів & таргетована реклама </li>
                ...
                <li className={"mb-3"}>Працювала з відомими брендами, великими блогерами (64к, 609к) та <b>ІТ продуктами на 200к реєстрацій!</b></li>
              </ul>
            </div>
          </section>
