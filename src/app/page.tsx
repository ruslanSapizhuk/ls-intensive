            ...
            <section className={"mb-10"}>
              <div className="text-center">
                ...
                <h2 className="text-3xl mt-5 uppercase font-bold mb-10 text-default">
                  створи та продавай свій міні продукт на автопілоті 24/7
                  <br/>
                  <span className={"text-black"}>всього за 14 днів</span>
                </h2>
                <p className="mb-5 text-xl">
                  Підходить для <b>експертів</b> з будь якої ніші (ІТ, ШІ, Фітнес, Б&#39;юті, Наука і т.д.), спеціалістів,
                  продюсерів, маркетологів
                </p>
                <div className={"bg-white rounded-3xl p-5 mb-5"}>
                  <p className="mb-5 text-center font-bold ">
                    Створюй курси, марафони, практикуми і відразу монетизуй їх за моєю авторською методикою👇
                  </p>
            ...
            <section>
              <div className="md:basis-7/12 flex-initial grow-0 align-bottom dark:text-black">
                ...
                <ul className="mb-5 list-disc list-inside mt-5 text-xl leading-7">
                  ...
                  <li className={"mb-3"}>Заснувала Digital агенцію <b className={"uppercase"}>business maker</b> -
                    розробка сайтів для бізнесу та експертів & таргетована реклама
                  </li>
                  <li className={"mb-3"}>Навчила більше <b>100 людей</b> запускам онлайн продуктів</li>
                  <li className={"mb-3"}><b>IT блогер:</b> експертний блог в IG 7к+ аудиторії</li>
                  <li className={"mb-3"}>Працювала з відомими брендами, великими блогерами (64к, 609к) та <b>ІТ продуктами
                    на 200к реєстрацій!</b></li>
                </ul>
              </div>
            </section>
            <section className="mb-10 bg-default px-5 py-10">
              <p className="text-white text-center text-xl mb-5 font-bold">
                👩‍💻Мій інтенсив - це покроковий шлях від ідеї створення онлайн продукту до запуску продажів в
                автоматизованому режимі 24/7 на холодну аудиторію
              </p>
            ...
            <section className="mb-10" id="pay">
              ...
              <div className={"bg-white rounded-3xl p-5 text-center"}>
                ...
                <ol className={"text-left list-decimal list-inside text-xl"}>
                  <li className={"mb-5"}>
                    Детальну інструкцію по налаштуванню таргету з нашими авторськими рекоментаціями.
                  </li>
                  <li className={"mb-5"}>
