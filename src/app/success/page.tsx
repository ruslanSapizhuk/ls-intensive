                        ...
                        <div>
                            ...
                            <div className="grow-1 bg-white rounded-3xl p-5">
                                ...
                                <p className="text-[18px] mb-5">
                                    *Доступи до чату з навчанням тобі прийдуть на пошту через декілька хвилин після оплати
                                </p>
                                <p className="text-[18px]">
                                    **Якщо доступи не прийшли скоріш за все пошта була введена з помилкою, напиши мені в інстаграм @lana.sapizhuk і ми знайдемо твою оплату та відкриємо доступ.
                                </p>
                            </div>
                        </div>
                    </section>
